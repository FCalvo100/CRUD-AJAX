...
function recargar () {
    ...
    peticion.open('GET', 'estudiantes/recargar');
	peticion.send();
}
...
var datos = 'nombre=' + nombre + "&apellido=" + apellido;
	...
	peticion.open('POST', 'estudiantes/' + this.value);
...
function eliminar () {
	...
	peticion.open('GET', 'estudiantes/eliminar/' + this.value);
	peticion.send();
}
...
function actualizar () {
	...
	peticion.open('GET', 'estudiantes/actualizar/' + this.value);
	peticion.send();	
}
